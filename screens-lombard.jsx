      ...
      <div className="phone-body flow-screen" style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div className="content">
          ...
          <div className="lombard-pledge-hero" style={{
            ...
            <div style={{ fontSize: 12, letterSpacing: 1.2, fontWeight: 600, color: "var(--color-secondary-500, #66969C)", textTransform: "uppercase", marginBottom: 8 }}>
            ...
            <div style={{ fontSize: 13, color: "var(--color-secondary-500, #66969C)", marginTop: 10 }}>
            ...
            {eligibleAssets.map(a => (
              ...
              >
                <span className="option-body">
                  ...
                  <span className="option-sub">{a.sub} · {fmtGBP(a.value, 2)}</span>
                </span>
